...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__ADDRESS__091C2A1B0B76AFDE");
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__Brands__DAD4F05E23FDEBA7");
        ...
        {
            entity.HasKey(e => e.CartItemId).HasName("PK__CartItem__488B0B0A373FF7F4");
        ...
        {
            entity.HasKey(e => e.FavoriteId).HasName("PK__Favorite__CE74FAD55A3F1CBA");
        ...
        {
            entity.HasKey(e => e.FavoriteDetailId).HasName("PK__Favorite__722A629CC752AD82");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E122B5A93A8");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BCF072FAD3C");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C4FCADBD4");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__9B556A3801A53439");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6CD64A6CD53");
        ...
        {
            entity.HasKey(e => e.VariantId).HasName("PK__ProductV__0EA2338418770878");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__74BC79CE3A747B62");
        ...
        {
            entity.HasKey(e => e.ReviewDetailId).HasName("PK__ReviewDe__9B1B82ABBD2675C7");
        ...
        {
            entity.HasKey(e => e.ShippingId).HasName("PK__Shipping__5FACD580FF58C40A");
