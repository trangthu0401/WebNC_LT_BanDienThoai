...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-CBFPI0HF\\QUOCHUNG;Database=DemoWebBanDienThoai;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__ACCOUNT__349DA58604C82382");

            entity.ToTable("ACCOUNT");

            entity.HasIndex(e => e.Email, "UQ__ACCOUNT__A9D10534F5C26FE9").IsUnique();
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__ADDRESS__091C2A1B6029A4FE");
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__Brands__DAD4F05EA34501D3");
        ...
        {
            entity.HasKey(e => e.CartItemId).HasName("PK__CartItem__488B0B0A1021B5F4");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__CUSTOMER__A4AE64B84B544790");
        ...
        {
            entity.HasKey(e => e.FavoriteId).HasName("PK__Favorite__CE74FAD536321CCD");
        ...
        {
            entity.HasKey(e => e.FavoriteDetailId).HasName("PK__Favorite__722A629CF529EF74");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E12267317BB");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BCF593189F8");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C49CE3226");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__9B556A3866C3380E");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6CD9C907166");
        ...
        {
            entity.HasKey(e => e.VariantId).HasName("PK__ProductV__0EA2338462E26D79");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__74BC79CEA5F8DB3B");
        ...
        {
            entity.HasKey(e => e.ReviewDetailId).HasName("PK__ReviewDe__9B1B82AB6A09CEC9");
        ...
        {
            entity.HasKey(e => e.ShippingId).HasName("PK__Shipping__5FACD580A3F75647");
